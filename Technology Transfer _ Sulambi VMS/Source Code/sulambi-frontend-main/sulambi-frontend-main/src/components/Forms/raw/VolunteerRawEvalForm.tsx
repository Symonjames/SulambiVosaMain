...
const VolunteerRawEvalForm = ({ eventData }: Props) => {
    ...
    >
      ...
      >
        <FormGeneratorTemplate
          ...
          fieldErrors={[]}
          template={[
            { type: "section", message: "TRAINING / SEMINAR EVALUATION FORM" },
            {
              id: "trainingTitle",
              type: "text",
              message: "Title of Training/ Seminar:",
              required: !eventData?.title,
            ...
            {
              type: "label",
              message: "Dear Participants,\n\nPlease evaluate the training/seminar in accordance with the criteria specified below. We assure you that your responses will be kept in strict confidentiality."
            },
            { type: "section", message: "Volunteer Experience Evaluation" },
            [
              {
            ...
            {
              type: "section",
              message: "Volunteer Feedback & Suggestions",
            },
            {
              id: "q13",
              type: "textQuestion",
...
export default VolunteerRawEvalForm;
